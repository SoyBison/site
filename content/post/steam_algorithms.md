...
<center>
A heat map showing the correlation between input cluster and output cluster. Inputs are along the x axis from left to right, and outputs are along the y axis from top to bottom.
</center>

<img class="dm-safe-img" src="/media/predictionshmap.png" width="250" height="250">
