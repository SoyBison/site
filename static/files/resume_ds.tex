...
\section{Overview}
{\large
 Computationally and Scientifically Driven Quantitative Researcher.
 3+ years of experience in Computational Social Science building research systems for academic and industry labs, with multiple projects in parallel.
 Strong focus on foundational methods for computational social science.
 ...
 Fast learner, and dedicated to the scientific endeavor.
 Passion for the process of applying computational methods to the real world.
}
